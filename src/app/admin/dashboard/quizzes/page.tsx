...
import { collection, query, orderBy, doc, deleteDoc, writeBatch, getDocs, where, documentId } from 'firebase/firestore';
...
const AdminQuizzesPage = () => {
    ...
    const quizzesQuery = useMemoFirebase(() => {
        ...
        return query(collection(firestore, 'quizzes'), orderBy('title'));
    }, [firestore]);
    ...
    const handleDeleteConfirm = async () => {
        ...
        try {
            ...
            if (selectedQuiz.questionIds && selectedQuiz.questionIds.length > 0) {
                ...
                // For production apps with more questions, this would need to be chunked.
                const questionsQuery = query(
                    collection(firestore, 'questions'),
                    where(documentId(), 'in', selectedQuiz.questionIds.slice(0, 30))
                );

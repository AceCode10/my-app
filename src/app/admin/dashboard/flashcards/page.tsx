...
const AdminFlashcardsPage = () => {
    ...
    const decksQuery = useMemoFirebase(() => {
        ...
        return query(collection(firestore, 'flashcardDecks'), orderBy('createdAt', 'desc'));
    }, [firestore]);
    ...
    const handleDeleteConfirm = async () => {
        ...
        try {
            ...
            // In a real app, we would also delete the subcollection of cards.
            // This requires a Cloud Function for efficiency.
            toast({
                title: "Deck Deleted",
        ...
        <>
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow>
                                ...
                                <TableHead>Created By (ID)</TableHead>
                            ...
                            {isLoading ? (
                                ...
                                <TableRow>
                                    <TableCell colSpan={6} className="h-24 text-center text-destructive">
                                        Error loading flashcard decks: {error.message}
                                    </TableCell>
                                </TableRow>
                            ) : (
                                decks?.map(deck => (
                                    <TableRow key={deck.id}>
                                        ...
                                        <TableCell className="font-mono text-xs">{deck.createdBy}</TableCell>
                                        <TableCell>
            ...
            <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
                <AlertDialogContent>
                    ...
                    <AlertDialogDescription>
                        This action cannot be undone. This will permanently delete the flashcard deck from the database. Note: Deleting associated cards requires a Cloud Function.
                    </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>

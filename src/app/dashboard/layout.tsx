...
const navItems = [
    ...
    { href: '/dashboard/subjects', label: 'Subjects', icon: <BookCopy /> },
...
const searchItems = [
    { name: 'Maths', category: 'subjects', path: '/dashboard/subjects' },
    { name: 'Physics', category: 'subjects', path: '/dashboard/subjects' },
    { name: 'ICT', category: 'subjects', path: '/dashboard/subjects' },

...
const EmptyState = ({ onOpenModal }: { onOpenModal: () => void }) => (
    <div className="text-center bg-background p-12 rounded-2xl border border-dashed">
        ...
        <div>
            ...
            <div className="flex flex-col sm:flex-row justify-between sm:items-center mb-8">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1">Manage your classes, view student progress, and schedule assessments.</p>
                </div>
            ...
            {isLoading ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {classes.map(c => {
                        ...
                        return (
                            <div key={c.id} className="bg-background p-6 rounded-2xl shadow-sm border flex flex-col justify-between hover:border-primary transition-all duration-300 hover:shadow-lg">
                                <div>
                                 ...
                                 <Button 
                                    ...
                                    onClick={() => router.push(`/teacher/dashboard/classes/${c.id}`)}
                                >

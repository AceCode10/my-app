...
import { ArrowLeft, Users, BarChart, FileText, Settings, UserPlus, Check, X, Trash2, Loader2, Save, Send, MessageSquare, Calendar as CalendarIcon, PlusCircle, Paperclip, BookOpen } from 'lucide-react';
import { Card, CardContent, CardHeader, CardTitle, CardDescription } from '@/components/ui/card';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@/components/ui/tabs';
import { Avatar, AvatarFallback, AvatarImage } from '@/components/ui/avatar';
import { useToast } from '@/hooks/use-toast';
import { useDoc, useCollection, useFirestore, useMemoFirebase, useUser } from '@/firebase';
import type { Class, UserProfile, QuizAttempt, Assignment, Quiz, Note, Announcement } from '@/types';
import { collection, doc, query, where, documentId, updateDoc, arrayUnion, arrayRemove, deleteDoc, getDocs, writeBatch, orderBy, addDoc, serverTimestamp, Timestamp } from 'firebase/firestore';
import { Skeleton } from '@/components/ui/skeleton';
import { ResponsiveContainer, Tooltip, Legend, Bar, BarChart as RechartsBarChart, CartesianGrid, XAxis, YAxis } from 'recharts';
...
const StudentList = ({ studentIds, title, onRemove }: { studentIds: string[], title: string, onRemove?: (studentId: string) => void }) => {

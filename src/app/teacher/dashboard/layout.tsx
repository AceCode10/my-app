...
const searchItems = [
    ...
    { name: 'Grade 10 - Core Mathematics', category: 'classes', path: '/teacher/dashboard/classes' },
    { name: 'Algebra Fundamentals Quiz', category: 'assessments', path: '/teacher/dashboard/assessments' },
    { name: 'Bob Williams', category: 'students', path: '#' },
    { name: 'Grade 11 - Physics', category: 'classes', path: '/teacher/dashboard/classes' },
];
...
const AppSidebar = () => {
    ...
    const navItems = [
        ...
        { href: '/teacher/dashboard/classes', label: 'My Classes', icon: <Users /> },
        { href: '/teacher/dashboard/notes', label: 'My Notes', icon: <BookOpen /> },
        { href: '/teacher/dashboard/assessments', label: 'Assessments', icon: <Edit /> },
        { href: '/teacher/dashboard/flashcards', label: 'Flashcards', icon: <Layers /> },
                ...
                <SidebarMenu>
                    <SidebarMenuItem>
                        <Link href="/teacher/dashboard/settings">
                             <SidebarMenuButton tooltip="Settings" isActive={pathname === '/teacher/dashboard/settings'}>
                                <Settings />
            ...
            <div className="flex items-center space-x-2 sm:space-x-5 justify-end w-1/3">
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent className="w-56">
                        ...
                        <DropdownMenuItem asChild>
                            <Link href="/teacher/dashboard/settings" className="flex items-center w-full">

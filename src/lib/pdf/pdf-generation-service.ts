  ...
  async generateTestPDF(assessmentId: string, options: PDFTestOptions): Promise<string> {
    try {
      ...
      html += `
          ...
          <div style="margin-top: 30px; display: flex; justify-content: space-between; align-items: center; color: #999; font-size: 12px;">
            <p style="margin: 0;">&copy; ${new Date().getFullYear()} IGA Prep</p>
            <p style="margin: 0;">For more, visit <a href="https://www.igaprep.com/" target="_blank" rel="noopener noreferrer" style="color: #666; text-decoration: underline;">igaprep.com</a></p>
          </div>
        </div>
      `;

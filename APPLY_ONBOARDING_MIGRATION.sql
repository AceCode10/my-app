...
-- This script applies the onboarding migration manually
...
-- Add level column to users (single level for students)
DO $$
BEGIN
    IF NOT EXISTS (
...
DO $$
BEGIN
    RAISE NOTICE 'Migration completed successfully! The user_subjects table and onboarding fields have been created.';
END $$;

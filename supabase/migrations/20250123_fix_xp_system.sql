-- ============================================
-- Fix XP System Migration
-- 1. Fix award_xp function to auto-create user_gamification record
-- 2. Add function to update daily goals when difficulty changes
...
DROP POLICY IF EXISTS "System can manage gamification" ON user_gamification;
...
-- Enable realtime for user_gamification
